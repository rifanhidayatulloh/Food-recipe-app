  ...
  return (
    <>
      <div className={styleregister.container}>
        <div className={styleregister.containerLeft}>
        ...
        <div className={styleregister.containerRegister}>
          <div className={styleregister.registerMain}>
            <h3 className={styleregister.registerMainH3}>
              Let's Get Started !
            </h3>
            <p className={styleregister.registerMainP}>
            ...
            <form onSubmit={(e) => onSubmit(e)}>
              ...
              <input
                ...
                id="name"
              />
              <label className={styleregister.registerMainEmail}>
                Email address
              </label>
              <input
                ...
                id="email"
              />
              <label className={styleregister.registerMainPhone}>
                Phone Number
              </label>
              <input
                ...
                id="phone"
              />
              <label className={styleregister.mainCreatePassword}>
                Create New Password
              </label>
              <input
                ...
                id="create-password"
              />
              <label className={styleregister.mainNewPassword}>
                New Password
              </label>
              <input
